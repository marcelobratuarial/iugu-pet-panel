<head>
	...
	<!--plugins-->
	<link href="<?= base_url("panel/assets/plugins/vectormap/jquery-jvectormap-2.0.2.css") ?>" rel="stylesheet"/>
	...
	<!-- Theme Style CSS -->
	<link rel="stylesheet" href="<?= base_url("panel/assets/css/dark-theme.css") ?>" />
	<link rel="stylesheet" href="<?= base_url("panel/assets/css/semi-dark.css") ?>" />
	<link rel="stylesheet" href="<?= base_url("panel/assets/css/header-colors.css") ?>" />
	<title><?= $pd["title"] ?> - IUGU PET</title>
</head>

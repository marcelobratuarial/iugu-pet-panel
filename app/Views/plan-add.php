                ...
                <form action="" id="addFeatureForm">
                    <div class="row">
                        <div class="col-8">
                            ...
                            <input name="feature_name" type="text" class="form-control" id="inputFeatureName" value="" placeholder="Exemplo de recurso">
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#AddFeatureModal').on('shown.bs.modal', function (e) {
            $("#addFeatureForm").find("input:first").focus()
        })
